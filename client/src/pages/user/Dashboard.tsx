...
>
  <h1
    className="fw-bold"
    style={{color: "#111827",marginTop: "20px",      marginBottom: "20px", fontSize: "2.3rem", }} >
    Welcome to VocabApp
  </h1>

  <p
    style={{ color: "#1F2937", fontSize: "1.1rem", maxWidth: "700px", marginBottom: "15px",  }} >
  ...
  <div className="d-flex justify-content-center gap-3 mt-1"> 
    <button
      ...
      style={{  padding: "12px 28px",  borderRadius: "8px", }} onClick={handleGetStarted}>
      Get Started
    </button>
